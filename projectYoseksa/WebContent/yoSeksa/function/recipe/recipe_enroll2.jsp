...
<title>만개의 레시피</title>
<link rel="stylesheet" type="text/css" href="./만개의 레시피_files/bootstrap_20150918.css">
<link rel="stylesheet" type="text/css" href="./만개의 레시피_files/font.css">
<link rel="stylesheet" type="text/css" href="./만개의 레시피_files/font-awesome.min.css">
<link rel="stylesheet" type="text/css" href="./만개의 레시피_files/ez_recipe_20151022.css">
<script async="" src="./만개의 레시피_files/analytics.js"></script><script id="facebook-jssdk" src="./만개의 레시피_files/sdk.js"></script><script type="text/javascript" src="./만개의 레시피_files/jquery-1.11.2.min.js" charset="utf-8"></script>
      ...
      <div class="modal-body">
        ...
        -->
            <div style="width:800px; height:560px; background:#fff; text-align:center;">
              <div sthyle="padding-top:5px;"><img src="./만개의 레시피_files/update_icon.gif"></div>
              <div style="font-size:30px; font-weight:bold; color:#444; padding-top:25px;">브라우저를 최신버전으로 업그레이드 해주세요!</div>
              <div style="font-size:18px; color:#777; padding-top:25px;">레시피 등록을 위해서는 지금 사용하고 있는<br>브라우저 버전을 업그레이드 하거나 다른 웹 브라우저를 사용해야 됩니다.</div>
              <div style="font-size:18px; color:#777; padding-top:25px;">아래의 브라우저 사진을 클릭하여 업그레이드 하세요.</div>
              <div style="padding-top:30px;">
                <a href="https://www.google.com/chrome/" target="_blank" style="margin:0 4px;"><img src="./만개의 레시피_files/update_b_03.gif" alt="chrome" style="border:none;"></a>
                <a href="http://windows.microsoft.com/ko-kr/internet-explorer/download-ie" target="_blank" style="margin:0 4px;"><img src="./만개의 레시피_files/update_b_02.gif" alt="IE" style="border:none;"></a>
              </div>
            </div>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal --><link rel="stylesheet" type="text/css" href="./만개의 레시피_files/jquery-ui-1.11.4_201507011.css">
<style>
.tagit {
...
<link rel="stylesheet" type="text/css" href="./만개의 레시피_files/jquery.tagit.css"><style>
...
<div class="container recipe_regi">
    ...
    <div class="regi_title">레시피 등록<a href="javascript:void(0)" id="btnRecipeInsertGuide"><img src="./만개의 레시피_files/btn_guide.gif" alt="레시피등록안내"></a></div>
    <div class="cont_box pad_l_60">
      <div id="divMainPhotoUpload" class="cont_pic2">
        ...
        <div id="divMainPhotoBox" is_over="0">
            <img id="mainPhotoHolder" onclick="browseMainFile()" src="./만개의 레시피_files/pic_none4.gif" style="width: 250px; height: 250px; cursor:pointer">
        </div>
      </div>
    ...
    <div class="cont_box pad_l_60">
      ...
      <div id="divStepArea" class="ui-sortable"><div id="divStepItem_1" class="step">
            ...
            <div id="divStepUpload_1" style="display:inline-block">
                ...
                <div id="divStepPhotoBox_1" is_over="0">
                    <img id="stepPhotoHolder_1" onclick="browseStepFile(1)" src="./만개의 레시피_files/pic_none2.gif" width="160" height="160" style="cursor:pointer">
                </div>
            </div>
          ...
          <div id="divStepItem_STEP" class="step">
            ...
            <div id="divStepUpload_STEP" style="display:inline-block">
                ...
                <div id="divStepPhotoBox_STEP" is_over="0">
                    <img id="stepPhotoHolder_STEP" onclick="browseStepFile(__STEP)" src="./만개의 레시피_files/pic_none2.gif" width="160" height="160" style="cursor:pointer">
                </div>
            </div>
      ...
      <div id="divWorkArea" style="display:inline-block">
            ...
            <div id="divWorkPhotoBox_1" is_over="0">
                ...
                <img id="workPhotoHolder_1" onclick="browseWorkFile(1)" src="./만개의 레시피_files/pic_none3.gif" alt="No Image" style="width: 140px; height: 140px; cursor:pointer">
            </div>
        </div>
            ...
            <div id="divWorkPhotoBox_2" is_over="0">
                <a href="http://www.10000recipe.com/inbox/insert.html#" class="pic_del" style="display:none"></a>
                <img id="workPhotoHolder_2" onclick="browseWorkFile(2)" src="./만개의 레시피_files/pic_none3.gif" alt="No Image" style="width: 140px; height: 140px; cursor:pointer">
            </div>
        </div>
            ...
            <div id="divWorkPhotoBox_3" is_over="0">
                <a href="http://www.10000recipe.com/inbox/insert.html#" class="pic_del" style="display:none"></a>
                <img id="workPhotoHolder_3" onclick="browseWorkFile(3)" src="./만개의 레시피_files/pic_none3.gif" alt="No Image" style="width: 140px; height: 140px; cursor:pointer">
            </div>
        </div>
            ...
            <div id="divWorkPhotoBox_4" is_over="0">
                <a href="http://www.10000recipe.com/inbox/insert.html#" class="pic_del" style="display:none"></a>
                <img id="workPhotoHolder_4" onclick="browseWorkFile(4)" src="./만개의 레시피_files/pic_none3.gif" alt="No Image" style="width: 140px; height: 140px; cursor:pointer">
            </div>
        </div>
              </div>
    </div><!--/cont_box-->
...
<div id="recipeInsertGuideModal" class="modal fade">
    <div class="modal-dialog" style="width:1000px">
        <div class="modal-content new_folder">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><img src="./만개의 레시피_files/btn_close.gif" alt="닫기"></span></button>
                <h4 class="modal-title text-left">레시피 등록방법</h4>
            </div>
            <div class="modal-body" style="padding:0;">
                <div class="guide_tit"><img src="./만개의 레시피_files/guide_tt.gif"></div>
                    ...
                    <div class="panel panel-default">
                        <a data-toggle="collapse" data-parent="#accordion" href="http://www.10000recipe.com/inbox/insert.html#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                            <div class="panel-heading" role="tab" id="headingOne">
                                <span class="guide_icon"><img src="./만개의 레시피_files/icon_guide_01.gif"></span>직접등록하기<i class="btn_arrow"><img src="./만개의 레시피_files/icon_arrow1_down.png"></i>
                            </div>
                        </a>
                        <div id="collapseOne" class="panel-collapse collapse out" role="tabpanel" aria-labelledby="headingOne">
                            <div class="panel-body" style="border-top:1px solid #e6e7e8;">
                                <img src="./만개의 레시피_files/guide1_01.jpg">
                                <br>
                                <img src="./만개의 레시피_files/guide1_02.jpg">
                                <br>
                                <img src="./만개의 레시피_files/guide1_03.jpg">
                            </div>
                        </div>
                    </div>
                    <!--/panel panel-default -->
                    ...
                    <div class="panel panel-default">
                        <a data-toggle="collapse" data-parent="#accordion" href="http://www.10000recipe.com/inbox/insert.html#collapseThree" aria-expanded="true" aria-controls="collapseThree">
                            <div class="panel-heading" role="tab" id="headingThree">
                                <span class="guide_icon"><img src="./만개의 레시피_files/icon_guide_03.gif"></span>전문 레시피로 바꾸기<i class="btn_arrow"><img src="./만개의 레시피_files/icon_arrow1_down.png"></i>
                            </div>
                        </a>
                        <div id="collapseThree" class="panel-collapse collapse out" role="tabpanel" aria-labelledby="headingThree">
                            <div class="panel-body" style="border-top:1px solid #e6e7e8;">
                                <img src="./만개의 레시피_files/guide3_01.jpg">
                                <br>
                                <img src="./만개의 레시피_files/guide3_02.jpg">
                                <br>
                                <img src="./만개의 레시피_files/guide3_03.jpg">
                            </div>
                        </div>
                    </div>
                    <!--/panel panel-default -->
...
<script type="text/javascript" src="./만개의 레시피_files/jquery-ui-1.11.4.js" charset="utf-8"></script>
<script type="text/javascript" src="./만개의 레시피_files/tag-it.min.js" charset="utf-8"></script>
<script type="text/javascript" src="./만개의 레시피_files/coreutil.min_20150609.js" charset="utf-8"></script>
<script type="text/javascript" src="./만개의 레시피_files/ui.min_20150609.js" charset="utf-8"></script>
